(function () {
  ...
  const API_ENDPOINT = (typeof window !== "undefined" && (window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1"))
    ? window.location.origin + "/api/events"
    : "https://user-analytics-platform.onrender.com/api/events";
